...
export class ProjectTransfarmer {
    ...
    ProjectTransfarmerEntity(Entity: ProjectEntity): Project {
        ...
        if (Entity.timesheetRequired === '1') { this.project.timesheetRequired = 'true'.toString().trim(); }
    ...
    ProjectTransfarmer(Project1: Project): ProjectEntity {
        ...
        if (Project1.timesheetRequired.toString().trim() === 'true') { this.projectEntity.timesheetRequired = '1'; } else { this.projectEntity.timesheetRequired = '0'; }
